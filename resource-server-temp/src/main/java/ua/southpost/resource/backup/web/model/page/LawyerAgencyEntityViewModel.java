...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "lawyerAgencyForm")})
public class LawyerAgencyEntityViewModel extends ExtendedRegionalEntityViewModel<Long> {
	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "lawyer/form";
}
