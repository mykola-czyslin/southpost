...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "locationForm")})
public class LocationEntityViewModel extends RegionalEntityViewModel<Long> {
	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "location/form";
}
