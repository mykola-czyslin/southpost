...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "emailForm")})
public class EmailEntityViewModel extends EntityViewModel<Long> {

	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "contact/email/form";
}
