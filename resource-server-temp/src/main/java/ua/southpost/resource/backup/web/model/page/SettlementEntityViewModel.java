...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "settlementForm")})
public class SettlementEntityViewModel extends RegionalEntityViewModel<Long> {
	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "settlement/form";
}
