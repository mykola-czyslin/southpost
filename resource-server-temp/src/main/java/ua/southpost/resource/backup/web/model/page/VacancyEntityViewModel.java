...
@ModelAttributeAliases({
		@ModelAttributeAlias(aliasFor = "entityForm", value = "vacancyForm"),
		@ModelAttributeAlias(aliasFor = "districtOptions", value = "contactDistrictOptions")
})
public class VacancyEntityViewModel extends ExtendedRegionalEntityViewModel<Long> {
	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "vacancy/form";
}
