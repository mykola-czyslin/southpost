...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "phoneForm")})
public class PhoneEntityViewModel extends EntityViewModel<Long> {
	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "contact/phone/form";
}
