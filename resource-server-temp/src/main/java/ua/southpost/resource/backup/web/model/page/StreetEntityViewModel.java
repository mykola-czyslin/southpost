...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "streetForm")})
public class StreetEntityViewModel extends RegionalEntityViewModel<Long> {
	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "street/form";
}
