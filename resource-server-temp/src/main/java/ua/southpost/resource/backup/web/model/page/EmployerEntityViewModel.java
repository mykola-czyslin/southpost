...
@ModelAttributeAliases({@ModelAttributeAlias(aliasFor = "entityForm", value = "employerForm")})
public class EmployerEntityViewModel extends ExtendedRegionalEntityViewModel<Long> {

	@ModelAttributeMapping(modelAttributeName = ControllerConstants.CONTENT_VIEW_MODEL_ATTRIBUTE)
	public static final String CONTENT_VIEW_PATH = "employer/form";
}
